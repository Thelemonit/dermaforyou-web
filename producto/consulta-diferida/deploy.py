#!/usr/bin/env python3
"""
Updates WooCommerce product 8443 (Consulta Dermatológica Diferida) with design C layout.
Includes: product section, protocol, CF7 form, real FAQ.
No WooCommerce tabs.
"""
...
CSS = """
/* ══ CONSULTA DIFERIDA — WooCommerce Override ══ */
...
@media(max-width:560px){ .skl-faq-band::before{display:none} }
...
@media(max-width:560px){ .skl-cp-steps{grid-template-columns:1fr} .skl-btn-row{grid-template-columns:1fr} .skl-security-row{flex-direction:column} .skl-sec-item{border-right:none;border-bottom:1px solid var(--light)} .skl-sec-item:last-child{border-bottom:none} }
"""
...
<div class="skl-top-bar">Respuesta en <strong>24–48 h laborables</strong> · Por WhatsApp · Prescripción médica certificada</div>
<div class="skl-breadcrumb-bar"><a href="https://www.dermaforyou.com/">Inicio</a><span>›</span><a href="https://www.dermaforyou.com/product-category/consulta-online/">Consulta Online</a><span>›</span>Consulta Dermatológica Diferida</div>

<section class="skl-product-section">
  <div class="skl-img-panel">
    <div class="skl-img-wrapper">
      <img src="https://www.dermaforyou.com/wp-content/uploads/2023/08/consulta-dermatologica-online-scaled.jpg"
           alt="Consulta Dermatológica Diferida por WhatsApp — Dra. Carmen Galera"
           width="480" height="600" loading="eager" style="object-position:top center;">
      <div class="skl-img-badge">Consulta<br>médica</div>
    </div>
    <div class="skl-trust-pills">
      <div class="skl-pill">💬 Por WhatsApp</div>
      <div class="skl-pill">🔬 Dermatóloga colegiada</div>
      <div class="skl-pill">📋 Respuesta personalizada</div>
    </div>
  </div>
  ...
  <div class="skl-content-panel">
    <div class="skl-content-header">
      <div class="skl-category-line">
        ...
        <span class="skl-ref-code">CONS-DIF-001</span>
      </div>
      <h1 class="skl-product-title">Consulta Dermatológica Diferida</h1>
      <p class="skl-product-sub">Consulta médica dermatológica por WhatsApp. Respuesta experta de la Dra. Carmen Galera en 24–48 horas laborables, sin necesidad de desplazarte.</p>
    </div>

    <div class="skl-credencial-row">
      <div class="skl-cred-item"><span>⭐</span> Diagnóstico médico real</div>
      <div class="skl-cred-sep"></div>
      <div class="skl-cred-item"><span>🔒</span> Datos protegidos</div>
      <div class="skl-cred-sep"></div>
      <div class="skl-cred-item"><span>📱</span> Vía WhatsApp</div>
    </div>

    <div class="skl-price-section">
      <div class="skl-price-label">Precio</div>
      <div class="skl-price-number">110<sup>€</sup></div>
      <p class="skl-price-desc">Pago único · Respuesta dermatológica personalizada
        <span class="skl-price-highlight">Incluye orientación sobre tratamiento y seguimiento</span>
      </p>
    </div>
    ...
    <div class="skl-indications-block">
      ...
      <div class="skl-indication-item">
        ...
        <p>Pacientes con dudas dermatológicas que no requieren visita presencial urgente.</p>
      </div>
      <div class="skl-indication-item">
        <span class="skl-ind-num">02</span>
        <p>Quienes buscan una segunda opinión médica especializada de forma rápida y sin desplazarse.</p>
      </div>
      <div class="skl-indication-item">
        <span class="skl-ind-num">03</span>
        <p>Personas que quieren orientación sobre tratamientos, productos o diagnósticos previos.</p>
      </div>
    </div>
    ...
    <div class="skl-doctor-verified">
      ...
      <div class="skl-dv-text">
        ...
        Responde personalmente cada consulta. Colegiada y especialista en dermatología clínica, estética y cosmética médica.
      </div>
    </div>

    <div class="skl-btn-wrap">
      <a href="?add-to-cart=8443" class="skl-btn-cart">Reservar consulta — 110 €</a>
      <div class="skl-btn-row">
        <a href="#skl-formulario" class="skl-btn-outline">Ir al formulario</a>
        <a href="https://www.dermaforyou.com/producto/consulta-dermatologica-por-videollamada/" class="skl-btn-outline">Ver videoconsulta</a>
...
<section class="skl-clinical-process">
  <div class="skl-cp-inner">
    <div class="skl-cp-header">
      ...
      <h2>Cómo funciona la Consulta Diferida</h2>
    </div>
...
<section class="skl-form-section" id="skl-formulario">
  <div class="skl-form-inner">
    <div class="skl-form-header">
      <p class="skl-form-eyebrow">Formulario</p>
      <h2>Rellena los datos de tu consulta</h2>
      <div class="skl-form-notice">
        <span class="skl-notice-icon">ℹ️</span>
        <p><strong>Esta consulta es diferida:</strong> recibirás la respuesta por WhatsApp en un plazo de 24–48 h laborables. <strong>No se realizan videollamadas.</strong> Si prefieres consulta por videollamada, puedes contratarla <a href="https://www.dermaforyou.com/producto/consulta-dermatologica-por-videollamada/">aquí</a>.</p>
      </div>
    </div>
    [contact-form-7 id="0227fe0" title="Formulario Consulta Dermatológica"]
  </div>
</section>
...
<section class="skl-faq-section" id="skl-faq">
  <div class="skl-faq-band">
    <div class="skl-faq-band-inner">
      ...
      <p class="skl-faq-band-sub">Respondemos las dudas más habituales sobre la consulta diferida.</p>
    </div>
  </div>
    ...
    <div class="skl-faq-grid">
      ...
      <div class="skl-faq-card" data-num="01">
        <div class="skl-faq-summary">
          ...
          <span class="skl-faq-qtext">¿En cuánto tiempo recibiré respuesta?</span>
          <div class="skl-faq-toggle"></div>
        </div>
        <div class="skl-faq-answer"><div class="skl-faq-answer-inner">La Dra. Carmen Galera se compromete a contestar tu consulta en un plazo máximo de 2 días laborables, a excepción de enfermedad, períodos vacacionales o festivos.</div></div>
      </div>
      ...
      <div class="skl-faq-card" data-num="03">
        <div class="skl-faq-summary">
          ...
          <span class="skl-faq-qtext">¿Puedo obtener una receta médica a través de esta consulta?</span>
          <div class="skl-faq-toggle"></div>
        </div>
      ...
      <div class="skl-faq-card" data-num="04">
        <div class="skl-faq-summary">
          ...
          <span class="skl-faq-qtext">¿Puedo renovar la receta de algún medicamento?</span>
          <div class="skl-faq-toggle"></div>
        </div>
      ...
      <div class="skl-faq-card" data-num="05">
        <div class="skl-faq-summary">
          ...
          <span class="skl-faq-qtext">¿La consulta diferida sustituye a la visita presencial?</span>
          <div class="skl-faq-toggle"></div>
        </div>
        <div class="skl-faq-answer"><div class="skl-faq-answer-inner">Depende del motivo de consulta. En cualquier caso ayudará a resolver problemas cutáneos menores, proporcionar orientación de tratamiento, hacer seguimiento de patologías ya diagnosticadas y realizar una primera valoración de patologías sin diagnosticar.</div></div>
      </div>

      <div class="skl-faq-card" data-num="06">
        <div class="skl-faq-summary">
          <span class="skl-faq-num">06</span>
          <span class="skl-faq-qtext">¿Sustituye a un servicio de urgencias?</span>
          <div class="skl-faq-toggle"></div>
        </div>
      ...
      <div class="skl-faq-card" data-num="09">
        ...
        <div class="skl-faq-answer"><div class="skl-faq-answer-inner">El pago de la consulta se realiza a través de la pasarela de pago segura de esta web.</div></div>
      </div>
      ...
      <div class="skl-faq-card" data-num="10">
        ...
        <div class="skl-faq-answer"><div class="skl-faq-answer-inner">Sí. Dermaforyou se toma muy en serio tu privacidad y aplica de forma estricta todas las disposiciones legales de la ley de protección de datos. Puedes consultar nuestra política de privacidad.</div></div>
      </div>
...
req = urllib.request.Request(
    "https://www.dermaforyou.com/wp-json/wp/v2/product/8443",
